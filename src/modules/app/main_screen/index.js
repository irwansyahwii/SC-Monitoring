...
(function() {
  var main_for_admin_controller, main_for_manager_controller, new_sc_controller, setup_routes_for_admin, setup_routes_for_manager, the_module;

  the_module = angular.module("dea.main_screen", []);

  setup_routes_for_manager = function($stateProvider) {
  ...
  setup_routes_for_admin = function($stateProvider) {
    ...
    return $stateProvider.state("main_for_admin.new_sc", {
      url: "/new_sc",
      views: {
        "tab_new_view": {
  ...
  the_module.config([
    "$stateProvider", function($stateProvider) {
      ...
      return setup_routes_for_admin($stateProvider);
    }
  ]);
