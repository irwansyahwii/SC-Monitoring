...
(function() {
  var main_for_admin_controller, main_for_manager_controller, setup_routes_for_admin, setup_routes_for_manager, the_module;
  ...
  setup_routes_for_admin = function($stateProvider) {
    ...
    return $stateProvider.state("main_for_admin.tab_new_view", {
      url: "/new",
      views: {
        "tab_new_view": {
